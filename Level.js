...
Level.prototype.load = function() {
    ...
    var self = this;
    this.reset_button = Buttons.reset(this.paper,10,10,30);
    this.reset_button
    ...
    this.level_select_button = Buttons.levelSelect(this.paper,50,10,30);
    this.level_select_button
...
Level.prototype.resolve = function() {
    this.resolveBeams();
    this.resolveGoals();
};

Level.prototype.resolveBeams = function() {
...
Level.prototype.resolveBeam = function(beam,depth) {
...
Level.prototype.resolveGoals = function() {
...
Level.prototype.check_solved = function() {
